...
class CommonRechargeableTicketBuilder implements RechargeableTicketBuilder {
    ...
    CommonRechargeableTicketBuilder(String name, UUID id, BigDecimal balance, BigDecimal usageCost) {
        this.name = name;
        this.id = id;
